...
if __name__ == '__main__':
        ...
        sys.stdout.flush()
        print("[Downloading] | ==============================>       | 83.0% | 5/6", end='\r', flush=True)
