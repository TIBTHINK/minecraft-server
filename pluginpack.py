...
if __name__ == '__main__':
        ...
        clear()
        print("\r[Downloading] | ==============================>       | 83% | 5/6", flush=True)
        ...
        clear()
        print("\r[Downloading] | ====================================> | 100% | 6/6", flush=True)